...
@theme {
  ...
  --color-brand-vizon: #F0EAE1;
  --color-brand-ivory: #FDFBF7;
  --color-brand-espresso: #1F1C19;
  --color-brand-dark: #141210;
  --color-brand-gold: #C5A880;
  --color-brand-goldDark: #A48358;
  --color-brand-goldLight: #EBE0D2;
  --color-brand-champagne: #C5A880;
...
:root {
  ...
  --shadow-luxury: 0 15px 35px rgba(116, 109, 101, 0.08);
  --shadow-hover: 0 22px 45px rgba(116, 109, 101, 0.14);
...
/* ==========================================================================
   1. GLOBAL RESET & BASE RULES (ZERO-OVERFLOW & ACCELERATED RENDERING)
   ========================================================================== */
*, *::before, *::after {
...
.gold-gradient-text {
  background: linear-gradient(135deg, #C5A880 0%, #A48358 50%, #D4B892 100%);
...
.reveal-stagger-parent.is-revealed .reveal-stagger-item:nth-child(1) { transition-delay: 0.06s; }
.reveal-stagger-parent.is-revealed .reveal-stagger-item:nth-child(2) { transition-delay: 0.14s; }
.reveal-stagger-parent.is-revealed .reveal-stagger-item:nth-child(3) { transition-delay: 0.22s; }
.reveal-stagger-parent.is-revealed .reveal-stagger-item:nth-child(4) { transition-delay: 0.30s; }
.reveal-stagger-parent.is-revealed .reveal-stagger-item:nth-child(5) { transition-delay: 0.38s; }
.reveal-stagger-parent.is-revealed .reveal-stagger-item:nth-child(6) { transition-delay: 0.46s; }

/* Legacy reveal support */
.reveal-up, .reveal-stagger-item {
  opacity: 1;
}
...
/* ==========================================================================
   3. LUXURY HEADER & OFFCANVAS DRAWER
   ========================================================================== */
.luxury-header,
.boutique-header {
  position: fixed;
  ...
  transition: height 0.35s var(--ease-expo), background 0.35s ease, box-shadow 0.35s ease;
  animation: brandSlideDown 0.8s var(--ease-expo) forwards;
}

.luxury-header.is-scrolled,
.boutique-header.is-scrolled {
  height: 72px;
  background: rgba(250, 247, 242, 0.98);
  box-shadow: 0 10px 30px rgba(116, 109, 101, 0.08);
...
/* ==========================================================================
   4. HERO SECTION WITH CINEMATIC PARALLAX & ENTRANCES
   ========================================================================== */
.boutique-hero {
  position: relative;
  width: 100%;
...
.hero-bg-layer {
  ...
  z-index: 0;
  opacity: 0;
  animation: heroImageFadeIn 1.1s var(--ease-expo) 0.15s forwards;
...
.hero-backdrop-scrim {
  position: absolute;
  inset: 0;
  background: linear-gradient(90deg, #FAF7F2 0%, #FAF7F2 38%, rgba(250, 247, 242, 0.85) 50%, rgba(250, 247, 242, 0) 100%);
  pointer-events: none;
  z-index: 1;
}
...
.hero-headline {
  ...
  letter-spacing: -0.02em;
  opacity: 0;
  animation: heroContentFadeUp 0.85s var(--ease-expo) 0.2s forwards;
}
...
.hero-description {
  ...
  max-width: 520px;
  opacity: 0;
  animation: heroContentFadeUp 0.85s var(--ease-expo) 0.35s forwards;
}
...
.hero-actions {
  ...
  flex-wrap: wrap;
  opacity: 0;
  animation: heroContentFadeUp 0.85s var(--ease-expo) 0.5s forwards;
}
...
.btn-hero-primary {
  ...
  align-items: center;
  gap: 8px;
  box-shadow: 0 8px 22px rgba(31, 28, 25, 0.22);
...
.btn-hero-primary:hover {
  ...
  box-shadow: 0 14px 30px rgba(31, 28, 25, 0.32);
}
...
.btn-hero-secondary::after {
  ...
  animation: subtleShimmer 4.5s infinite var(--ease-smooth);
  pointer-events: none;
}
...
/* ==========================================================================
   5. COMMON SECTION STYLES & CTA BUTTONS
   ========================================================================== */
.boutique-section {
  width: 100%;
  padding: 95px 24px;
...
/* ==========================================================================
   6. HİZMETLERİMİZ (BENTO MOSAIC & HOVER LIFT)
   ========================================================================== */
#hizmetler {
...
.bento-item:hover {
  ...
  box-shadow: 0 18px 40px rgba(116, 109, 101, 0.16);
  border-color: var(--gold-primary);
}
...
.bento-overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.25) 45%, transparent 70%) !important;
  display: flex;
...
.bento-item:hover .bento-overlay {
  background: linear-gradient(to top, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.35) 50%, transparent 75%) !important;
}
...
.bento-item.tall .bento-overlay h3 {
  font-size: 1.35rem;
}

/* ==========================================================================
   7. TRANSPARAN RENKLENDİRME & BAĞ KORUMA (#teknikler)
   ========================================================================== */
.section-teknikler {
  background-color: #FAF7F2;
  border-bottom: 1px solid rgba(197, 168, 128, 0.2);
...
/* ==========================================================================
   8. ÖNCE SAĞLIK, SONRA GÜZELLİK (#felsefe) - DARK SECTION
   ========================================================================== */
.section-felsefe {
...
/* ==========================================================================
   9. GÜVEN & KALİTE STANDARTLARI (#neden-biz) & METRIC COUNT-UP
   ========================================================================== */
.section-neden-biz {
  background-color: #FAF7F2;
  border-bottom: 1px solid rgba(197, 168, 128, 0.2);
...
.trust-metric-card:hover {
  border-color: #C5A880;
  transform: translateY(-4px);
  box-shadow: 0 18px 42px rgba(197, 168, 128, 0.18);
}
...
/* ==========================================================================
   10. 4 ADIMDA SÜREÇ & ONARIM VİTRİNİ (#surec)
   ========================================================================== */
.section-process {
  background-color: #FAF7F2;
  border-bottom: 1px solid rgba(197, 168, 128, 0.2);
...
.process-step-card:hover {
  transform: translateY(-6px);
  box-shadow: 0 18px 45px rgba(197, 168, 128, 0.16);
  border-color: var(--gold-primary);
}
...
/* ==========================================================================
   11. INSTAGRAM REELS VİTRİNİ (#reels)
   ========================================================================== */
#reels {
...
.insta-story-ring {
  ...
  border-radius: 50%;
  padding: 3px;
  background: linear-gradient(135deg, #A48358 0%, #C5A880 50%, #EBE0D2 100%);
  display: flex;
  align-items: center;
  justify-content: center;
  flex-shrink: 0;
...
.reel-media-wrapper:hover .reel-play-btn-overlay {
  transform: translate(-50%, -50%) scale(1.1);
  background: rgba(0, 0, 0, 0.75);
  border-color: #FFFFFF;
}

.reel-media-wrapper.is-playing .reel-play-btn-overlay {
  opacity: 0;
  pointer-events: none;
}
...
.reel-icon-btn.heart-btn.liked svg {
  fill: #E0245E;
  color: #E0245E;
}
...
/* ==========================================================================
   12. GOOGLE REVIEWS SLIDER (#yorumlar)
   ========================================================================== */
#yorumlar {
...
.review-nav-btn.prev-btn { left: -22px; }
.review-nav-btn.next-btn { right: -22px; }
...
/* ==========================================================================
   13. SALONUMUZDAN KARELER GALERİ (#galeri)
   ========================================================================== */
#galeri {
  background-color: #FAF7F2;
  border-bottom: 1px solid rgba(194, 163, 121, 0.18);
...
.gallery-tile:hover {
  transform: translateY(-6px);
  box-shadow: 0 20px 45px rgba(116, 109, 101, 0.14);
  border-color: var(--gold-primary);
}
...
/* ==========================================================================
   14. SIKÇA SORULAN SORULAR ACCORDION (#sss)
   ========================================================================== */
#sss {
  background-color: #FAF7F2;
  border-bottom: 1px solid rgba(197, 168, 128, 0.2);
...
.faq-item.active {
  border-color: var(--gold-primary);
  box-shadow: 0 10px 28px rgba(197, 168, 128, 0.14);
}
...
.contact-card-box {
  ...
  border-radius: 24px;
  border: 1px solid rgba(197, 168, 128, 0.25);
  box-shadow: 0 20px 50px rgba(116, 109, 101, 0.08);
  padding: 56px 48px;
  display: grid;
...
/* ==========================================================================
   17. COMPLETE RESPONSIVE BREAKPOINT SUITE (TABLET & MOBILE)
   ========================================================================== */
...
@media (max-width: 768px) {
  ...
  /* 2. Hero: Background Image with Soft Bottom Scrim */
  .boutique-hero {
  ...
  .tech-content-box .btn-espresso-luxury,
  .trust-content-box .btn-espresso-luxury {
    width: 100% !important;
    justify-content: center !important;
    text-align: center !important;
  ...
  /* 7. Process Vertical Timeline Mobile */
  .process-timeline-grid {
    grid-template-columns: 1fr !important;
    gap: 14px !important;
  ...
  .repair-callout-box .btn-espresso-luxury {
    width: 100% !important;
    justify-content: center !important;
  }
  ...
  .review-nav-btn.prev-btn { left: -10px !important; }
  .review-nav-btn.next-btn { right: -10px !important; }
  ...
  .mobile-call-btn {
    ...
    border: 1px solid rgba(31, 28, 25, 0.25) !important;
    color: #1F1C19 !important;
  }

  .mobile-wa-btn {
    background: linear-gradient(135deg, #C5A880 0%, #A48358 100%) !important;
    color: #FFFFFF !important;
    border: none !important;
    box-shadow: 0 4px 12px rgba(164, 131, 88, 0.3) !important;
  }
}
