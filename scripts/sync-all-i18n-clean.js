...
const I18N_TRANSLATIONS = ${JSON.stringify(dict, null, 2)};
...
fs.writeFileSync(i18nPath, fullCode, 'utf8');
fs.writeFileSync(publicI18nPath, fullCode, 'utf8');
console.log('Clean i18n files created successfully!');
