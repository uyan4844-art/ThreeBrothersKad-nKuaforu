...
/* ==========================================================================
   2. BOUTIQUE FLOATING HEADER & DRAWER
   ========================================================================== */
.boutique-header {
  position: fixed;
  top: 0;
...
/* ==========================================================================
   3. HERO SECTION (EDITORIAL SALON SHOWCASE)
   ========================================================================== */
.boutique-hero {
  position: relative;
  width: 100%;
...
@media (max-width: 768px) {
  ...
  .hero-backdrop-scrim {
    ...
    height: 100% !important;
    z-index: 1 !important;
    background: linear-gradient(180deg, rgba(250, 247, 242, 0.12) 0%, rgba(250, 247, 242, 0.78) 48%, #FAF7F2 88%) !important;
    display: block !important;
  }
