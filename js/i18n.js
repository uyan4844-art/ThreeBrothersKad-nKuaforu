...
const I18N_TRANSLATIONS = {
  "tr": {
    ...
    "hero_desc": "Manavgat'ta saçın sağlığını koruyan profesyonel balyaj, mikro kaynak ve kişiye özel sarışınlık tasarımı. Saçınızı yıpratmadan, teninize en çok yakışan tonu birlikte keşfedelim.",
    "hero_btn_explore": "Hizmetlerimizi Keşfet",
    "hero_btn_wa": "Randevu & Saç Analizi",
    ...
    "health_kicker": "UZMANLIK & GÜVEN",
    "health_title": "Saçlarınızın Sağlığı Bizim İçin Her Şeyden Önemli",
    "health_p1": "Three Brothers salonumuzda renklendirme ve kesim işlemlerine geçmeden önce saç yapınızı inceliyor, saçınızı yıpratacak hiçbir adıma onay vermiyoruz.",
    "health_p2": "En kaliteli bakım ürünleri ve dürüst hizmet anlayışımızla, saçlarınızın canlılığını koruyarak size en çok yakışan ışıltıyı kazandırıyoruz.",
  ...
  "en": {
    ...
    "hero_title": "Flawless Color,<br />Natural Elegance.",
    "hero_desc": "Protecting hair health with professional balayage, micro extensions, and bespoke blonde artistry in Manavgat. Discover the perfect tone tailored to your complexion.",
    "hero_btn_explore": "Explore Our Services",
    "hero_btn_wa": "Booking & Hair Analysis",
    ...
    "health_kicker": "EXPERTISE & TRUST",
    "health_title": "The Health of Your Hair Comes Before Everything",
    "health_p1": "At Three Brothers salon, before proceeding with coloring and cutting, we carefully examine your hair structure and never approve any step that could compromise its vitality.",
    "health_p2": "With the highest quality care products and an honest service approach, we protect the vitality of your hair while giving you the radiance that suits you best.",
    "health_btn": "Book Consultation & Analysis",
  ...
  "de": {
    ...
    "hero_title": "Perfekte Farbe,<br />Natürliche Eleganz.",
    "hero_desc": "Haarschonende Balayage, Mikrogewebe-Extensions und individuelles Blond-Design in Manavgat. Entdecken Sie Ihre perfekte Farbharmonie.",
    "hero_btn_explore": "Leistungen Entdecken",
    "hero_btn_wa": "Termin & Haaranalyse",
    ...
    "health_kicker": "EXPERTISE & VERTRAUEN",
    "health_title": "Die Gesundheit Ihres Haares steht für uns an erster Stelle",
    "health_p1": "Im Salon Three Brothers prüfen wir vor jeder Coloration und jedem Haarschnitt sorgfältig Ihre Haarstruktur und stimmen keinen Schritten zu, die Ihr Haar strapazieren könnten.",
    "health_p2": "Mit hochwertigsten Pflegeprodukten und ehrlicher Beratung bewahren wir die Vitalität Ihres Haares und verleihen Ihnen den perfekten, strahlenden Glanz.",
  ...
  "ru": {
    ...
    "hero_title": "Безупречный Цвет,<br />Естественная Элегантность.",
    "hero_desc": "Бережный профессиональный балаяж, микрокапсульное наращивание и авторский блонд в Манавгате. Откройте оттенок, идеально подчеркивающий вашу красоту.",
    "hero_btn_explore": "Наши Услуги",
    "hero_btn_wa": "Запись и Анализ Волос",
    ...
    "health_kicker": "ЭКСПЕРТИЗА И ДОВЕРИЕ",
    "health_title": "Здоровье ваших волос для нас важнее всего",
    "health_p1": "В салоне Three Brothers перед любым окрашиванием и стрижкой мы внимательно изучаем структуру ваших волос и не допускаем никаких процедур, которые могут их повредить.",
    "health_p2": "Используя средства премиум-ухода и честный подход, мы сохраняем силу ваших волос и создаем сияющий образ, который вам идеально подходит.",
  ...
  "ar": {
    "health_kicker": "الخبرة والثقة",
    "health_title": "صحة شعركِ هي أولويتنا المطلقة",
    "health_p1": "في صالون Three Brothers، نقوم بفحص بنية شعركِ بعناية قبل أي خطوة في التلوين أو القص، ولا نوافق أبداً على أي إجراء قد يجهد شعركِ.",
    "health_p2": "باستخدام أجود منتجات العناية ونهج الخدمة الصادق، نحافظ على حيوية شعركِ ونمنحكِ الإشراقة الأكثر ملاءمة لجمالكِ.",
    ...
    "hero_title": "لون متقن،<br />وأناقة طبيعية.",
    "hero_desc": "بالياج احترافي يحافظ على صحة الشعر، وصلات ميكرو كبسول، وتصميم أشقر مخصص في مانافجات. دعينا نكتشف معاً التدرج الأكثر تناغماً مع بشرتكِ.",
    "hero_btn_explore": "استكشف خدماتنا",
    "hero_btn_wa": "حجز موعد وتحليل الشعر",
