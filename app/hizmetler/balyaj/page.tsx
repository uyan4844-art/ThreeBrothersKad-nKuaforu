    ...
    <main className="min-h-screen bg-[#FAF7F2] text-[#1F1C19] selection:bg-[#C5A880]/30">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-stone-500 mb-6 font-montserrat">
          ...
          <span>/</span>
          <span className="text-[#1F1C19]">Balyaj</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
            ...
            <h3 className="font-serif text-xl font-bold text-[#1F1C19]">3.5 – 5 Saat</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
            ...
            <h3 className="font-serif text-xl font-bold text-[#1F1C19]">Plex Bağ Koruma</h3>
            <p className="text-xs text-stone-500 mt-2 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
            ...
            <h3 className="font-serif text-xl font-bold text-[#1F1C19]">6 – 8 Ay</h3>
            <p className="text-xs text-stone-500 mt-2 leading-relaxed">
