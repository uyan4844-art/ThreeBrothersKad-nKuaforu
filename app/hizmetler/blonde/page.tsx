    ...
    <main className="min-h-[100dvh] bg-[#FAF7F2] text-[#1F1C19] selection:bg-[#C5A880]/30 pb-[calc(6rem+env(safe-area-inset-bottom,0px))] md:pb-0">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-stone-500 mb-6 font-montserrat">
          ...
          <span>/</span>
          <span className="text-[#1F1C19]">Blonde</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
            ...
            <h3 className="font-serif text-xl font-bold text-[#1F1C19]">4 – 6 Saat</h3>
          </div>
          <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
            <span className="text-xs font-bold text-[#A48358] uppercase tracking-wider block mb-1">
              Ürün Protokolü
            </span>
            <h3 className="font-serif text-xl font-bold text-[#1F1C19]">Davines & Olaplex</h3>
          </div>
          <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
            <span className="text-xs font-bold text-[#A48358] uppercase tracking-wider block mb-1">
              Özel Bakım
            </span>
            <h3 className="font-serif text-xl font-bold text-[#1F1C19]">Hyalüronik Asit</h3>
          </div>
        </div>
